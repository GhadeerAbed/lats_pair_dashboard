...
export const DashSvg = (props: any) => {
  return (
    <svg
      width="24"
      height="24"
    ...
    >
      ...
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M16.2855 13.7656H19.5521C20.9036 13.7656 22 14.8715 22 16.2368V19.5297C22 20.894 20.9036 21.9999 19.5521 21.9999H16.2855C14.933 21.9999 13.8366 20.894 13.8366 19.5297V16.2368C13.8366 14.8715 14.933 13.7656 16.2855 13.7656Z"
        fill="currentColor"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
